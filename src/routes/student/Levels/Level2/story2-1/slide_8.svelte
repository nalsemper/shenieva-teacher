<script>
    ...
    function startNarration() {
        ...
        setTimeout(() => {
            ...
            audioEl.play().catch(e => console.warn('[slide_8] Play blocked:', e));
        }, 150);
    }
