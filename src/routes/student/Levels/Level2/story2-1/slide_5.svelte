<script>
    ...
    const slide = {
        ...
        image: '/converted/assets/LEVEL_2/STORY_1/PIC4.webp'
    };
    ...
    // playlist: HH5, Hector_s Mother_, HH6, HECTOR
    $: playlist = (() => {
        const base = '/assets/audio/story-telling/Level_2/story_1';
        const sp = speed === 'slow' ? 'slow' : (speed === 'fast' ? 'fast' : 'normal');
        return [
            `${base}/${sp}/slide_5/HH5.mp3`,
            `${base}/${sp}/slide_5/Hector_s Mother_.mp3`,
            `${base}/${sp}/slide_5/HH6.mp3`,
            `${base}/${sp}/slide_5/HECTOR.mp3`
        ];
    })();
