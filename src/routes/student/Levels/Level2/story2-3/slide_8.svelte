<script>
    ...
    // Audio source with speed variants (slow has different filename, fast has lowercase 'c')
    $: audioSrc = (() => {
...
<div class="slide-container" bind:this={containerEl}>
    ...
    <div class="image-wrapper"><img src={slide.image} alt="Decision" class="story-image"/></div>
