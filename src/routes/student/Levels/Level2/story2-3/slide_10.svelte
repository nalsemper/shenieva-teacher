<script>
    ...
    const slide = {
        ...
        cebuano: { text: "Sukad niadto, nagsugod si Royce pagtipig pag-usab ug kwarta alang sa iyang pangandoy nga dulaan. Wala siya nagbasol sa pagtabang sa iyang igsoon kay nagtuo siya nga importante ang magtabang sa uban una kaysa sa iyang kaugalingong gusto." },
    ...
    $: audioSrc = (() => {
        ...
        const filename = sp === 'slow' ? 'R8.mp3' : 'RC8.mp3';
        return `${base}/${sp}/slide_10/${filename}`;
    })();
...
<div class="slide-container" bind:this={containerEl}>
    ...
    <div class="image-wrapper"><img src={slide.image} alt="Saving again" class="story-image"/></div>
