<script>
    ...
    const slide = {
        english: {
            text: "There was once a boy named Hector who constantly eats unhealthy foods like too much sweets, causing his obesity.",
        },
        cebuano: {
        ...
        image: '/converted/assets/LEVEL_2/STORY_1/PIC1.webp'
    };
    ...
    $: audioSrc = (() => {
        ...
        return `${base}/${speedFolder}/slide_2/HH1.mp3`;
    })();
...
<audio bind:this={audioEl} on:ended={() => { isPlaying = false; exitStoryMode(); }} on:pause={() => { isPlaying = false; }} style="display:none;"></audio>
