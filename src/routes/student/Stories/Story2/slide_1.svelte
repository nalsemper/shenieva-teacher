<script>
    ...
    const slide = {
        english: {
            text: "Story -3 Shenievia Reads stands at the edge of Readville Village. 'Time to head home!' she says with a grin. 🌟",
            audioFast: '/src/assets/audio/fast.mp3',
            audioSlow: '/src/assets/audio/slow.mp3'
        },
        cebuano: {
            text: "Story -3 Si Shenievia Reads nagbarug sa daplin sa Readville Village. 'Panahon na sa pagpauli!' ningisi sya 🌟",
