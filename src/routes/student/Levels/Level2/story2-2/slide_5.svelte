<script>
    ...
    const questions = [
        { id: 1, text: "What actions do you think Maya will take?" },
        { id: 2, text: "How will Maya help the old woman?" },
        { id: 3, text: "Once the old woman wakes up, how will she feel about Maya?" },
    ...
    let answers = [
        ...
        { id: 'a3', text: 'She will feel thankful to Maya for her kindness and for being helpful.', assignedTo: null },
        { id: 'a4', text: 'She will praise and thank Maya.', assignedTo: null }
    ];
    ...
    $: isLocked = $studentData?.submittedQuizzes?.['story2-2'] || false;
    ...
    (function restore() {
        ...
        const subscriber = function (data) {
            try {
                ...
                const saved = answered['story2-2_slide5'];
                if (saved) {
