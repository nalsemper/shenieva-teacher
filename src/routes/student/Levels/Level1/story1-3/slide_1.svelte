<script>
    ...
    $: audioSrc = (() => {
        ...
        return `${base}/${sp}/slide_1/H1.mp3`;
    })();

    // Start audio with debouncing
    let playToken = 0;
