<script>
    ...
    const slide = {
        english: { text: "As he was about to leave, he noticed that his mother was struggling to manage the money." },
        cebuano: { text: "Samtang padulong na siya mulakaw, nakamatikod siya nga naglisod ang iyang inahan sa pagdumala sa kwarta." },
        image: '/converted/assets/LEVEL_2/STORY_3/Pic3.webp'
    };
    ...
    $: audioSrc = (() => {
        ...
        const filename = sp === 'slow' ? 'R3.mp3' : 'RC3.mp3';
        return `${base}/${sp}/slide_4/${filename}`;
    })();
...
<div class="slide-container" bind:this={containerEl}>
    ...
    <div class="image-wrapper"><img src={slide.image} alt="Mother struggling" class="story-image"/></div>
