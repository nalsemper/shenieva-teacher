<script>
    ...
    const slide = {
        english: { text: "When he got home, he handed the medicine to his mother. His mother felt proud and thankful to Royce." },
        cebuano: { text: "Pag-abot niya sa balay, gihatag niya ang tambal sa iyang inahan. Ang iyang inahan nakabati ug garbo ug pasalamat kang Royce." },
        image: '/converted/assets/LEVEL_2/STORY_3/Pic7.webp'
    };
    ...
    $: audioSrc = (() => {
        const base = '/assets/audio/story-telling/Level_2/story_3';
        const sp = speed === 'slow' ? 'slow' : (speed === 'fast' ? 'fast' : 'normal');
        const filename = sp === 'slow' ? 'R7.mp3' : 'RC7.mp3';
        return `${base}/${sp}/slide_9/${filename}`;
    })();
...
<div class="slide-container" bind:this={containerEl}>
    ...
    <div class="image-wrapper"><img src={slide.image} alt="Home" class="story-image"/></div>
