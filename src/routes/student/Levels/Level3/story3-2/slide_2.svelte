<script>
    ...
    const slide = {
        ...
        image: "/converted/assets/LEVEL_3/STORY_2/PIC1.webp"
    };
    ...
    $: audioSrc = (() => {
        const base = '/assets/audio/story-telling/Level_3/story_2';
        const sp = speed === 'slow' ? 'slow' : (speed === 'fast' ? 'fast' : 'normal');
        let filename = sp === 'normal' ? 'LG 1.mp3' : 'LG1.mp3';
        return `${base}/${sp}/slide_2/${filename}`;
    })();
...
<div class="slide-container" bind:this={containerEl}>
    ...
    <div class="story-text" transition:fade>{$language === 'english' ? slide.text.english : slide.text.cebuano}</div>
